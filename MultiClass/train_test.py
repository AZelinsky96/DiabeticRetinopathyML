...
base = "/home/zeski/Documents/PythonLessons/MachineLearning/Projects/DiabeticRetinopathy/ProjectData/train_images"

def train_test_split(test_size = 0.1):
    ## This is the list that the files are in for the directory
    directories  = ["No_Diabetic_Retinopathy","Mild" , "Moderate" , "Severe", "Proliferative_Diabetic_Retinopathy"]
    ...
    for i in directories:
        ...
        destination_path_test = base + "/model_test/{}/".format(i)
        destination_path_train = base + "/model_train/{}/".format(i)
